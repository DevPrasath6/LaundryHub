                            ...
                            <div className="space-y-3">
                                {machines.map((machine) => (
                                    <div
                                        ...
                                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedMachine === machine.id
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-3 h-3 rounded-full ${machine.status === "available" ? "bg-secondary" : "bg-accent"
                                                    }`} />

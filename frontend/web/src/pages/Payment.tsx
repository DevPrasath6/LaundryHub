                            ...
                            <Card className="p-6 shadow-card border-0">
                                ...
                                <div className="space-y-3 mb-6">
                                    <div
                                        ...
                                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedMethod === "card" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
                                            }`}
                                    >
                                    ...
                                    <div
                                        ...
                                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedMethod === "wallet" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
                                            }`}
                                    >
                                        <div className="flex items-center gap-3">
                                    ...
                                    <div
                                        ...
                                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedMethod === "upi" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
                                            }`}
                                    >
                                        <div className="flex items-center gap-3">
